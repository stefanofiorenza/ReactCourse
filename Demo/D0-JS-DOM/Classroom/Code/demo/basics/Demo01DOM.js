...
function highlightSelected(){
    ...
    document.querySelectorAll('li').forEach(node => {node.style.background='yellow'})
...
function addNewNodes(){
    ...
    let nodeMainDiv =createNestedDivElementsWithDomApi('test with inner html')
    contentDivNode.innerHTML="";
    contentDivNode.appendChild(nodeMainDiv)
}
