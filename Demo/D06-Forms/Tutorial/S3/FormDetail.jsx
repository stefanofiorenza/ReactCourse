                        ...
                        <Card title="User Profile" category="" icon="icon-single-02" >
                            <Row>
                                ...
                                <RowColumn size="8">
                                    ...
                                    <input type="text" className="form-control col-md-10" disabled={true} value="" /><br />
                                    <input type="text" className="form-control col-md-10" placeholder="firstName" value={this.state.firstName} /><br />
                                    <input type="text" className="form-control col-md-10" placeholder="lastName" value={this.state.lastName}  /> <br />
                                    <input type="text" className="form-control col-md-10" placeholder="city" value={this.state.city} /> <br />
                                    <input type="text" className="form-control col-md-10" placeholder="email" value={this.state.email} /> <br />
                                </RowColumn>
                            </Row>
